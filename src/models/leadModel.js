...
function leadValidationRules() {
  return [
    body('organization_number').isString().withMessage("Value Must be String.")
                              .exists().withMessage("Required Key/Value Pair")
                              .notEmpty().withMessage("Can not be Empty"),
    body('phone').isString().withMessage("Value Must be String.").optional(),
    body('email').isString().withMessage("Value Must be String.").optional(),
    ...
    body('mobile').isString().withMessage("Value Must be String.").optional(),
    ...
    body('specific_lead_source').isString().withMessage("Value Must be String").optional()
